...
function WriteToFile(){
	...
	$pwd = getcwd();
	$twoPathParts = explode($public, $pwd);
	$src = "$twoPathParts[0]$public/items/templates/index_pdf/";
...
function copy_directory2($source, $dest, $permissions = 0777)
{
    // Check for symlinks
    if (is_link($source)) {
    ...
    while (false !== $entry = $dir->read()) {
        ...
        copy_directory2("$source/$entry", "$dest/$entry", $permissions);
    }
